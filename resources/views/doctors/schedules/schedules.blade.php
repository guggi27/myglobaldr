...
@section('main')
    ...
    <div class="container my-3">
        ...
        <script>
            ...
            const MAX_ROWS = 5; // fix rows count per day (like in your screenshot)
            ...
            function renderCalendar(date) {
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    column.innerHTML = `
        <div class="schedules-day-header">${days[i]}</div>
        <div class="schedules-day-date">${dayDate.toDateString().slice(4, 10)}</div>
      `;
