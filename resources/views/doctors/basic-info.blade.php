  ...
  <div class="container my-3">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form onsubmit="doSubmit(event);" enctype="multipart/form-data">
            ...
            <input type="submit" name="submit"
              class="btn btn-primary bg-primary-gradient"
              value="Next" />
          </form>
    ...
    async function doSubmit(event) {
      ...
      try {
        ...
        const response = await axios.post(
            baseUrl + "/appointment/basic-info",
            formData
        );
        ...
        if (response.data.status == "success") {
          ...
          window.location.href = baseUrl + "/doctors/" + doctorUserId + "/payment";
        } else {
