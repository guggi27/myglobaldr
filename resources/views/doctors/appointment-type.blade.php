...
@section ("main")
  ...
  <div class="container my-3">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <button type="button" onclick="selectAppointmentType('audio_call');">Audio call</button>
          <button type="button" onclick="selectAppointmentType('video_call');">Video call</button>
        </div>
      </div>
  </div>
  ...
  <script>
    ...
    function selectAppointmentType(type) {
      ...
      window.location.href = baseUrl + "/doctors/" + doctorUserId + "/basic-info";
    }
  </script>
