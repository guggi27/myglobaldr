...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg" style="position: sticky;
          ...
          <div class="container">
            ...
            <div class="d-lg-none d-flex flex-column align-items-end gap-1">
              ...
              <!-- Phone Number -->
              <a href="tel:{{ fetch_setting('emergency_number') }}"
                 class="btn no-border fw-bold"
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
              ...
              <ul class="navbar-nav gap-4">
                <li class="nav-item">
                  <a class="nav-link {{ request()->url() == url('/') ? 'active color-primary' : '' }}" href="{{ url('/') }}">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ request()->url() == url('/services') ? 'active color-primary' : '' }}" href="{{ url('/services') }}">Services</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ request()->url() == url('/doctors') ? 'active color-primary' : '' }}" href="{{ url('/doctors') }}">Find Doctors</a>
                </li>
                <li class="nav-item">
              ...
              <div class="d-flex">
                ...
                @if (auth()->check())
                  <div class="dropdown">
                    <button class="btn btn-primary bg-primary-gradient dropdown-toggle no-border" type="button" id="dropText1" data-bs-toggle="dropdown" aria-expanded="false">
                      {{ auth()->user()->name }}
                    </button>
            ...
            <div class="container pt-5 pb-5">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <span style="color: #FF005F;
                            height: 130px;
                            display: flex;
                            align-items: flex-end;">Experience personalized medical care from the comfort of your home.</span>
                    </div>
        ...
        <a href="https://wa.me/{{ fetch_setting('whatsapp_number') }}" 
