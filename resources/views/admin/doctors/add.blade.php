      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form onsubmit="addDoctor(event);" id="form-add-doctor">
    ...
    async function addDoctor(event) {
      ...
      try {
        const response = await axios.post(
          baseUrl + "/admin/doctors/add",
          formData
        )

        if (response.data.status == "success") {
          swal.fire("Add doctor", response.data.message, "success")
            .then(function () {
              window.location.href = baseUrl + "/admin/doctors";
            });
        } else {
