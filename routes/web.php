...
Route::any("/register", [DoctorRegisterController::class, "index"]);
...
Route::get("/doctors/{id}/payment", [DoctorController::class, "payment"]);
Route::get("/doctors/{id}/basic-info", [DoctorController::class, "basic_info"]);
Route::get("/doctors/{id}/appointment-type", [DoctorController::class, "appointment_type"]);
Route::get("/doctors/{id}/appointment", [DoctorController::class, "appointment"]);
...
Route::get("/doctors/{id}/schedules/update", [UpdateSchedule::class, "index"])->name("doctors.schedules.update");
...
Route::group([
    ...
    Route::post("/appointments/fetch", [PatientController::class, "fetch_appointment"]);
